...
public class InsuranceController {
	...
	ResponseEntity<List<Insurance>> getByTypeAndLesserPremium(@PathVariable("type") String type, @PathVariable("premium") double premium){
